...
> {
  ...
  renderSwitcher = () => {
    ...
    const switcherCls = mergeClasses([
      styles.treeSwitcher,
      (styles as any)[
        `tree-switcher_${expanded ? TREE_NODE_ICON_OPEN : TREE_NODE_ICON_CLOSE}`
      ],
    ]);
    ...
    return (
      <span
        className={mergeClasses([
          ...
          (disabled || disableCheckbox) && styles.treeCheckboxDisabled,
        ])}
  ...
  render() {
    ...
    const ariaSelected =
      selectable !== undefined ? { 'aria-selected': !!selectable } : undefined;
    ...
    return (
      <div
        ...
        className={mergeClasses([
          ...
          {
            [`tree-treenode-switcher-${expanded ? 'open' : 'close'}`]: !isLeaf,
          },
          ...
          },
          {
            [styles.filterNode]:
              filterTreeNode &&
              filterTreeNode(convertNodePropsToEventData(this.props)),
          },
        ])}
        style={style}
        // Draggable config
