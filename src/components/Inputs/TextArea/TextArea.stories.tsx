        ...
        <main>
          <article>
            <section>
              <h1>Text Area</h1>
              <p>
                Text areas give people a way to enter and edit text. They're
                used in forms, modal dialogs, tables, and other surfaces where
                multiline text input is required.
              </p>
              <h2>Best practices</h2>
              <h3>Layout</h3>
              <ul>
                <li>
                  There are four text area sizes that may be specified via the{' '}
                  ...
                  <b>TextInputSize.Flex</b> is the default and resizes the text
                  area automatically with the viewport. To prevent this
                  responsive behavior, give the text area a size.
                </li>
                <li>
                  Use a single line text input component when short entries are
                  expected.
                </li>
              </ul>
              <h3>Content</h3>
              <ul>
                <li>
                  Include a short label above the text area to communicate what
