        ...
        <main>
          <article>
            <section>
              <h1>Panels</h1>
              <p>
                Panels are overlays that contain supplementary content and are
                used for complex creation, edit, or management experiences. For
                example, viewing details about an item in a list or editing
                settings.
              </p>
              ...
              <ul>
                <li>
                  Use for self-contained experiences where someone doesn't need
                  to interact with the app view to complete the task.
                </li>
                <li>
                  Consider how the panel and its contained contents will scale
                  across responsive web breakpoints.
                </li>
              </ul>
              <h3>Header</h3>
              <ul>
                ...
                <li>
                  The header can contain a variety of components. Components are
                  stacked under the main title, locked to the top, and push
                  content down.
                </li>
              </ul>
              <h3>Body</h3>
              ...
              <ul>
                <li>
                  Standard footers include primary and secondary buttons to
                  confirm or cancel the changes or task.
                </li>
                <li>Read-only panels may contain a single Close button.</li>
                <li>Lock the footer to the bottom of the panel.</li>
              </ul>
              <h2>Content</h2>
              <h2>Title</h2>
              <ul>
                ...
                <li>Don't put a period at the end of the title.</li>
              </ul>
              <h2>Button labels</h2>
              <ul>
                <li>
