        ...
        <main>
          <article>
            <section>
              <h1>Dialog</h1>
              <p>
                A dialog is a temporary pop-up that takes focus from the page or
                app and requires people to interact with it. It's primarily used
                for confirming actions, such as deleting a file, or asking
              ...
              <ul>
                ...
                <li>Dialogs consist of a header, body, and footer.</li>
                <li>
                  Validate that people's entries are acceptable before closing
                  the dialog box. Show an inline validation error near the field
                  they must correct.
                </li>
                <li>
                  Disruptive dialogs should be used very sparingly, only when it
                  is critical that people make a choice or provide information
                  before they can proceed. Disruptive dialogs are generally used
                  for irreversible or potentially destructive tasks. They're
                  typically paired with an overlay without a light dismiss.
                </li>
              </ul>
              <h3>Header</h3>
              <ul>
                <li>Locks to the top of the dialog.</li>
                <li>May include an icon to the left of the title.</li>
                <li>Includes a Close button in the top-right corner.</li>
              </ul>
              <h3>Body</h3>
              <ul>
                <li>
                  The body is a flexible container that can house a wide variety
                  of components, content, and formatting.
                </li>
                <li>Content can scroll.</li>
              </ul>
              <h3>Footer</h3>
              <ul>
                <li>Lock buttons to the bottom of the dialog.</li>
                <li>
                  Include one primary button. A secondary button is optional.
                </li>
              </ul>
              <h2>Content</h2>
              <h2>Title</h2>
              <ul>
                ...
                <li>
                  This mandatory content should explain the main information in
                  a clear, concise, and specific statement or question. For
                  example, “Delete this file?” instead of “Are you sure?”
                </li>
                <li>
                  The title shouldn't be a description of the body content. For
                  example, don't use “Error” as a title. Instead, use an
                  informative statement like “Your session ended.”
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  Use actionable language, with the most important information
                  at the beginning.
                </li>
                <li>
                  Use the optional body content area for additional info or
                  instructions, if needed. Only include information needed to
              ...
              <ul>
                <li>
                  ...
                  information in the title. The title “Delete this file?” could
                  have buttons labeled “Delete” and “Cancel”.
                </li>
                <li>
                  Be concise. Limit labels to one or two words. Usually a single
                  verb is best. Include a noun if there is any room for
                  interpretation about what the verb means. For example,
                  “Delete” or “Delete file”.
                </li>
              </ul>
            </section>
            <section>
