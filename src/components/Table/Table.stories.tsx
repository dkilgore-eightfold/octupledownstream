        ...
        <main>
          <article>
            <section>
              <h1>Table</h1>
              <p>
                A table displays columns and rows of data. Specify the{' '}
                <code>dataSource</code> of Table as an array of data objects.
              </p>
              <h2>Best practices</h2>
              <h3>Layout</h3>
              <ul>
                <li>You may add borders, title and footer for table.</li>
                <li>
                  There are three sizes: <code>small</code>, <code>medium</code>
                  , and <code>large</code>.
                </li>
                ...
                <li>
                  The pagination may be positioned using a simple array:{' '}
                  <code>['topRight', 'none']</code>, or{' '}
                  <code>['none', bottomRight']</code>
                </li>
                <li>
                  Rows may be selectable by marking the first column as a
                  selectable via a property in your <code>dataSource</code>. You
                  can use <code>rowSelection.type</code> to set selection type.
                  Default is <code>checkbox</code>.
                </li>
                <li>
                  Rows may be expandable via the <code>expandableConfig</code>{' '}
                  prop.
                </li>
                <li>
                  Ellipsis cell content via setting <code>column.ellipsis</code>
                  . Ellipsis cell content via setting{' '}
                  <code>column.ellipsis.showTitle</code>, use a{' '}
                  <code>Tooltip</code> with its <code>portaled</code> prop
                  enabled instead of the html title attribute.
                </li>
                <li>
                  Table column title supports <code>colSpan</code> that set in
                  column. Table cell supports <code>colSpan</code> and{' '}
                  <code>rowSpan</code> that set in render return object. When
                  each of them is set to 0, the cell will not be rendered.
                </li>
                <li>
                  Display tree structure data in Table when there is field key
                  children in <code>dataSource</code>, customize{' '}
                  <code>childrenColumnName</code> property to avoid tree table
                  structure. You can control the indent width by setting{' '}
                  <code>indentSize</code>.
                </li>
                <li>Tables may be nested.</li>
                <li>
                  Set <code>Summary</code> content by <code>summary</code> prop.
                  You can fixed it by setting the <code>Table.Summary</code>{' '}
                  <code>fixed</code> prop.
                </li>
              </ul>
              <h3>Content</h3>
              <ul>
                <li>Display a collection of structured data.</li>
