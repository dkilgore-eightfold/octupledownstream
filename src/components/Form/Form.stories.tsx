        ...
        <main>
          <article>
            <section>
              <h1>Form</h1>
              <p>
                A Form component with data scope management. Including data
                collection, verification, and styles.
              </p>
            </section>
            <section>
            ...
            rules={[
              {
                validator: async (_, names) => {
                  if (!names || names.length < 2) {
                    return Promise.reject(new Error('At least 2 profiles'));
                  } else {
                      ...
                      {() => (
                        ...
                        >
                          <Select
                            ...
                            onOptionsChange={(o) => {
                              onSelectSitesChange(o, field.name);
                            }}
                            options={(
                              sights[
              ...
              {({ getFieldValue }) => {
                ...
                return users.length ? (
                      ...
                      <li key={index}>
                        ...
                        >
                          <Avatar
                            ...
                            size={'40px'}
                            style={{
                              backgroundColor: 'var(--accent-color-40)',
                            }}
                            type={'round'}
                          />
                          <span
                  ...
                  <Stack direction={'horizontal'} gap={'s'} fullWidth>
                    ...
                    <span>
                      {' '}
                      Click on thew 'Add profile' button to add a profile.
                    </span>
                  </Stack>
                );
              }}
        ...
        >
          <Form.Item name="modifier">
            <RadioGroup
              ...
              items={[
                {
                  ariaLabel: 'Not interested in the position anymore',
                  id: 'group3-0',
            ...
            {({ getFieldValue }) =>
              getFieldValue('modifier') === 'Radio4' ? (
                <Form.Item name={'reason'} rules={[{ required: true }]}>
                  <TextArea inputWidth={TextInputWidth.fill} />
                </Form.Item>
              ) : null
            }
          </Form.Item>
    ...
    <ConfigProvider
      ...
      children={
        ...
        >
          ...
          <Form.Item name={'month-picker'} label={'Month'} {...config}>
    ...
    <ConfigProvider
      ...
      children={
        <Form {...args} {...formItemLayout}>
          ...
          >
            <TextInput placeholder={'unavailable choice'} id={'error'} />
          </Form.Item>
          ...
          <Form.Item label={'Warning'} hasFeedback validateStatus={'warning'}>
            <TextInput htmlType={'password'} placeholder={'Password'} />
          </Form.Item>
          <Form.Item label={'Error'} hasFeedback validateStatus={'error'}>
            <TextInput
              htmlType={'password'}
