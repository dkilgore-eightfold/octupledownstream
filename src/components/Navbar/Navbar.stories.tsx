        ...
        <main>
          <article>
            <section>
              <h1>Navbar</h1>
              <p>
                A navigation bar is a section of a graphical user interface
                intended to aid visitors in accessing information. Navigation
                bars are implemented in file browsers, web browsers and as a
                design element of some web sites.
              </p>
            </section>
            <section>
          ...
          <NavbarContent>
            <Link
              ...
              onMouseEnter={() => {
                ...
                linkRef.current.style.color = 'var(--navbar-text-hover-color)';
              }}
              onMouseLeave={() => {
                linkRef.current.style.backgroundColor = 'transparent';
                linkRef.current.style.color = 'var(--navbar-text-color)';
              }}
            >
              Eightfold
            </Link>
