        ...
        <main>
          <article>
            <section>
              ...
              <p>
                Like toggle button, Two State buttons require the <b>toggle</b>{' '}
                attribute in addition to <b>checked</b>. Two State button's
                visual state is different than a basic Toggle button.
              </p>
            </section>
            <section>
